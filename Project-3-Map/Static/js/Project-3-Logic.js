...
// Define markerSize() function that will give each city a different radius based on its dog population
function markerSize(population) {
    return Math.sqrt(population) * 1000;
}

// Each city object contains the city's name, coordinates, and dog population
let cities = [
    {
        name:"Lambertville",
...
// Loop through cities array, and create a marker for each city object
for (let i = 0; i < cities.length; i++) {
    L.circle(cities[i].location, {
        fillOpacity: 0.75,
        color: "white",
        fillColor: "red",
        // Setting circle's radius to equal the output of our markerSize() function to make markersize and population proportinoate
